...
public class AntiXSS {
    ...
    /**
     * Returns a string object encoded to be used in an HTML attribute. <p> This
     * method will return characters a-z, A-Z, 0-9, full stop, comma, dash, and
     * underscore unencoded, and encode all other character in decimal HTML
    ...
    /**
     * Returns a string object encoded to use in HTML. <p> This method will
     * return characters a-z, A-Z, space, 0-9, full stop, comma, dash, and
     * underscore unencoded, and encode all other character in decimal HTML
     * entity format (i.e. < is encoded as &#60;).
     *
    ...
    /**
     * Returns a string object encoded to use in JavaScript as a string. <p>
     ...
     * \u0177). <p> The encoded string will be returned enclosed in single quote
     * characters (i.e. ').
     *
    ...
    /**
     * Returns a string object encoded to use in a URL context. <p> This method
     * will return characters a-z, A-Z, 0-9, full stop, dash, and underscore
     * unencoded, and encode all other characters in short hexadecimal URL
     * notation. for non-unicode character (i.e. < is encoded as %3c), and as
    ...
    /**
     * Returns a string object encoded to use in VBScript as a string. <p> This
     * method will return characters a-z, A-Z, space, 0-9, full stop, comma,
     * dash, and underscore unencoded (each substring enclosed in double
    ...
    /**
     * Returns a string object encoded to be used in an XML attribute. <p> This
     * method will return characters a-z, A-Z, 0-9, full stop, comma, dash, and
     * underscore unencoded, and encode all other character in decimal entity
     * format (i.e. < is encoded as &#60;).
     *
    ...
    /**
     * Returns a string object encoded to use in XML. <p> This method will
     * return characters a-z, A-Z, space, 0-9, full stop, comma, dash, and
     * underscore unencoded, and encode all other character in decimal entity
     * format (i.e. < is encoded as &#60;).
     *
    ...
    public static String EncodeHtmlSimples(String strInput) {
        if (strInput.length() == 0) {
            return EmptyString;
        }
        StringBuffer builder = new StringBuffer(strInput.length() * 2);
